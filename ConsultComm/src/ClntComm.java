...
public class ClntComm extends javax.swing.JPanel {
  ...
  void loadPlugins() {
    try{
      ...
      for(CsltCommPlugin plugin : PluginManager.getPluginList())
        plugin.unregister();
      ...
      for(CsltCommPlugin plugin : PluginManager.getPluginList()) {
        ...
        for(JMenuItem item : menuItems) //Add menu items to the main interface
          toolMenu.add(item);
      }
  ...
  private void readLayout() {
    ...
    try { //Remember expanded/collapsed rows
      ...
      Vector<Integer> expandedRows = (Vector<Integer>)d.readObject();
      d.close();
