...
public class TableTree extends JTable {
  ...
  public void setModel(TableTreeModel tableTreeModel) {
    ...
    Vector<TreePath> expanded = adapter.getExpandedPaths(); //Save the expanded rows for the model
  ...
  class ListToTreeSelectionModelWrapper extends DefaultTreeSelectionModel {
    ...
    EventListener[] getListSelectionModelListeners(Class<ListSelectionListener> classType) { return listSelectionModel.getListeners(classType); }
    void setListSelectionModelListeners(EventListener[] listeners) {
      for(EventListener listener : listeners)
        listSelectionModel.addListSelectionListener((ListSelectionListener)listener);
    }
  }
}
